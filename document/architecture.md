...
| Accessibility | WCAG 2.2 mức AA cho mọi giao diện. Test component chạy axe-core với tag `wcag2a`, `wcag2aa`, `wcag21a`, `wcag21aa`, `wcag22aa`; tiêu chí axe không đo được trên jsdom (focus bị che, thao tác kéo, kích thước mục tiêu bấm, xác thực, độ tương phản) được kiểm tra bằng test component và kiểm tra tay | Lựa chọn của dự án. WCAG 2.2 là W3C Recommendation hiện hành và bao trùm 2.1; áp dụng trước khi dựng giao diện editor thì ít phải sửa lại nhất |
