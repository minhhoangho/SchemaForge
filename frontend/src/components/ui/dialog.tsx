...
// The label is required exactly when the footer renders its close button.
type DialogFooterCloseButtonProps =
  | { hasCloseButton: true; closeLabel: string }
  | { hasCloseButton?: false; closeLabel?: never };
...
function DialogFooter({
  ...
  children,
  ...props
}: React.ComponentProps<"div"> & DialogFooterCloseButtonProps): JSX.Element {
  return (
    <div
